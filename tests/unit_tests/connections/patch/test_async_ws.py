...
#         outcome = await self.connection.patch("user:tobie")
...
#         await self.connection.socket.close()
#
#     async def test_patch_record_id(self):
#         record_id = RecordID("user","tobie")
#         outcome = await self.connection.patch(record_id)
#         print(outcome)
#         # self.assertEqual(1, len(outcome))
#         outcome = await self.connection.query("SELECT * FROM user;")
#         print(outcome)
...
#     #     await self.connection.socket.close()
#     #
#     # async def test_patch_table(self):
#     #     await self.connection.query("DELETE user;")
#     #
#     #     table = Table("user")
